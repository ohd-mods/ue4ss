...
RegisterKeyBind(Key.F10, function() Utils.Exec("disconnect") end)
RegisterKeyBind(Key.F12, function() Utils.Exec("quit") end)
RegisterKeyBind(Key.END, function() Utils.Exec("RemoveAllBots") end)
RegisterKeyBind(Key.INS, function() Utils.Exec("AddBots 11") end)